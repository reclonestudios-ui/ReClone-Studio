  ...
  return (
    <AnimatePresence>
      {isVisible && (
        <motion.button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-blood-red text-white w-12 h-12 rounded-full flex items-center justify-center text-2xl z-50 shadow-lg hover:bg-red-700 transition-colors duration-300"
