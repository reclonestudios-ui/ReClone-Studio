          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="mt-6 sm:mt-8 w-full max-w-md mx-auto">
              <div className="flex flex-col sm:flex-row gap-3 justify-center px-4">
                <button className="bg-blue-500 text-white font-medium text-xs sm:text-sm py-1.5 sm:py-2 px-4 sm:px-6 rounded hover:bg-blue-700 transition duration-300 w-full sm:w-auto flex items-center justify-center gap-1.5 sm:gap-2">
